...
namespace BethanyPieShop.Models
{
    public class ShoppingCart : IShoppingCart
    {
        ...
        private ShoppingCart(BethanyPieShopDbContext bethanysPieShopDbContext)
        {
        ...
        public int RemoveFormCart(Pie pie)
        {
            var shoppingCartItem =
                    _bethanysPieShopDbContext.ShoppingCartItems.SingleOrDefault(
                        s => s.Pie.PieId == pie.PieId && s.ShoppingCartId == ShoppingCartId);
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            return ShoppingCartItems ??=
                       _bethanysPieShopDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Include(s => s.Pie).ToList();
        }
